...
Критичное правило: если задача требует MCP-инструментов, браузерного поиска, GitHub/веб-документации, навигации по странице или внешних инструментов, выполняй её через эти инструменты и не откатывайся на слабую модель. Используй доступные MCP/веб-инструменты напрямую и возвращай короткий, точный результат.
